...
public class RecipeDetailsRecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    TextView mTextView;
    MyRecyclerViewClickListener itemClickListener;

    RecipeDetailsRecyclerViewHolder(View itemView) {
        super(itemView);
